...
HD_PWD='b:/efpga/finalproject/ip_repo/edit_my_rotary_encoder_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_rotary_encoder_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_rotary_encoder_v1_0.tcl
