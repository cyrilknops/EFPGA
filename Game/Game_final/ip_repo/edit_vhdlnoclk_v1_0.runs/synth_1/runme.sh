...
HD_PWD='C:/LEDMATRIX_PROJECT/ip_repo/edit_vhdlnoclk_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vhdlnoclk_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vhdlnoclk_v1_0.tcl
