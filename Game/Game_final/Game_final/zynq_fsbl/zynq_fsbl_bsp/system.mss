...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = MATRIX_IPBLOK_DEF
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = MATRIX_IPBLOK_DEF_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = my_rotary_en
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = my_rotary_en_0
END
