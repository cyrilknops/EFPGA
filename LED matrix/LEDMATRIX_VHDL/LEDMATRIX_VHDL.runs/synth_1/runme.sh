...
HD_PWD='C:/OEF2_LEDMATRIX_COUNTDOWN/OEF2_LED_COUNTDOWN/OEF2_LED_COUNTDOWN.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OEF2_LED_COUNTDOWN.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OEF2_LED_COUNTDOWN.tcl
